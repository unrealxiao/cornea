...
dir_name = 'G:/OCM_MCFM_Data/E/Combined_data/Tissue imaging/PiG imaging/Eye1/endo1/OCM_1mm by 1mm/asc_file/'
...
while(1):
    ...
    if k == 27:
        ...
        cv2.imwrite('E:/3Dimage/Intensity/OCT_Pupillary_Test/corneadata/input/' + 'input_' + str(i) + '.jpg', reserve_img.copy())
        cv2.imwrite('E:/3Dimage/Intensity/OCT_Pupillary_Test/corneadata/output/' + 'output_' + str(i) + '.jpg', mask_img)
        print("save data_" + str(i))
